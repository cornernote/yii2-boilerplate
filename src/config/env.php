...
$dotenv->required(['APP_NAME', 'APP_VERSION', 'APP_SUPPORT_EMAIL', 'APP_ADMIN_EMAIL', 'APP_LOCALE', 'APP_TIMEZONE', 'APP_COOKIE_DOMAIN', 'APP_COOKIE_VALIDATION_KEY', 'APP_SWITCH_IDENTITY_SESSION_KEY']);
